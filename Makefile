...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Mon Oct 10 09:48:19 2016
# Project:  faceRec.pro
# Template: app
# Command: /usr/local/QtEmbedded-4.7.2-arm/bin/qmake -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile faceRec.pro
#############################################################################
...
Makefile: faceRec.pro  /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++/qmake.conf /usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/g++.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/unix.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/linux.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/common/qws.conf \
		/usr/local/QtEmbedded-4.7.2-arm/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec /usr/local/QtEmbedded-4.7.2-arm/mkspecs/qws/linux-mxc-g++ CONFIG+=debug -o Makefile faceRec.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/faceRec1.0.0/ && $(COPY_FILE) --parents stream.h detectobject.h recognition.h .tmp/faceRec1.0.0/ && $(COPY_FILE) --parents main.cpp stream.cpp detectobject.cpp recognition.cpp .tmp/faceRec1.0.0/ && (cd `dirname .tmp/faceRec1.0.0` && $(TAR) faceRec1.0.0.tar faceRec1.0.0 && $(COMPRESS) faceRec1.0.0.tar) && $(MOVE) `dirname .tmp/faceRec1.0.0`/faceRec1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/faceRec1.0.0
